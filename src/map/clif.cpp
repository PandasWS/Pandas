...
//************************************ 
void clif_party_join_reply(map_session_data* sd, const char* player_name, const char* party_name, enum e_party_join_reply reply) {
	nullpo_retv(sd);
...
// Access:      public 
// Parameter:   map_session_data * sd
// Parameter:   map_session_data * applicant_sd
// Returns:     void
// Author:      Sola丶小克(CairoLee)  2021/10/17 19:55
//************************************ 
void clif_party_join_ask_approval(map_session_data* sd, map_session_data* applicant_sd) {
	nullpo_retv(sd);
...
// Author:      Sola丶小克(CairoLee)  2021/10/17 19:55
//************************************ 
void clif_parse_party_request_to_join(int fd, map_session_data* sd) {
	nullpo_retv(sd);
...
// Author:      Sola丶小克(CairoLee)  2021/10/17 19:55
//************************************ 
void clif_parse_party_approval_result(int fd, map_session_data* sd) {
	nullpo_retv(sd);
