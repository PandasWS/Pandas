...
int32 battle_damage(struct block_list *src, struct block_list *target, int64 damage, int16 div_, uint16 skill_lv, uint16 skill_id, enum damage_lv dmg_lv, pec_uint16 attack_type, bool additional_effects, t_tick tick, bool isspdamage, bool is_norm_attacked = false);
...
// eAthena additions
	...
	int32 atcmd_no_permission;				// 当没有权限的玩家执行了 GM 指令时的处理策略
