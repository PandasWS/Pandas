...
#else
	||	SQL_ERROR == stmt.BindColumn( 9,  SQLDT_UINT,   &p.str, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 10, SQLDT_UINT,   &p.agi, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 11, SQLDT_UINT,   &p.vit, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 12, SQLDT_UINT,   &p.int_, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 13, SQLDT_UINT,   &p.dex, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 14, SQLDT_UINT,   &p.luk, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
...
#else
	||	SQL_ERROR == stmt.BindColumn( 49, SQLDT_UINT,   &p.pow, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 50, SQLDT_UINT,   &p.sta, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 51, SQLDT_UINT,   &p.wis, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 52, SQLDT_UINT,   &p.spl, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 53, SQLDT_UINT,   &p.con, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn( 54, SQLDT_UINT,   &p.crt, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
...
#else
	||	SQL_ERROR == stmt.BindColumn(10, SQLDT_UINT,   &p->str, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(11, SQLDT_UINT,   &p->agi, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(12, SQLDT_UINT,   &p->vit, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(13, SQLDT_UINT,   &p->int_, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(14, SQLDT_UINT,   &p->dex, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(15, SQLDT_UINT,   &p->luk, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
...
#else
	||	SQL_ERROR == stmt.BindColumn(66, SQLDT_UINT,   &p->pow, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(67, SQLDT_UINT,   &p->sta, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(68, SQLDT_UINT,   &p->wis, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(69, SQLDT_UINT,   &p->spl, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(70, SQLDT_UINT,   &p->con, 0, nullptr, nullptr)
	||	SQL_ERROR == stmt.BindColumn(71, SQLDT_UINT,   &p->crt, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
