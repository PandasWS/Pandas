...
int32 battle_damage(struct block_list *src, struct block_list *target, int64 damage, t_tick delay, uint16 skill_lv, uint16 skill_id, enum damage_lv dmg_lv, pec_ushort attack_type, bool additional_effects, t_tick tick, bool spdamage);
