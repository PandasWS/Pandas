...
static void clif_item_equip( int16 idx, struct EQUIPITEM_INFO *p, struct item *it, struct item_data *id, int32 eqp_pos, uint16 caller = 0 ){
...
#ifndef Pandas_Fix_Clif_MVP_Exp_Type_Conversion
...
#endif // Pandas_Fix_Clif_MVP_Exp_Type_Conversion
...
#else
	if(!sd->state.autotrade && (mapdata->getMapFlag(MF_LOADEVENT) || battle_config.force_loadevent))
