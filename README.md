...
> 熊猫模拟器 (Pandas) 是一个开源的多人协作的软件开发项目. 致力构建符合中文用户习惯的大型多人在线角色扮演游戏服务端. 该程序使用 C++ 编写, 遵循 C++11 标准. 程序的灵活性非常强大, 可以对 NPC, 传送点等一系列内容进行修改. 该项目由全球各地的志愿者小组, 以及提供质量检查和支持的庞大社区共同管理. 熊猫模拟器基于 rAthena 构建, 而 rAthena 是 eAthena 项目的延续.
...
## 1. 配置要求
在使用熊猫模拟器之前, 您需要确保拥有符合要求的硬件配置, 并准备好某些工具或者应用程序. 根据操作系统的不同, 所需的工具也可能不同, 请看下文.
...
> 熊猫模拟器依赖 Boost C++ Libraries 1.71.0, 若使用 Windows 推荐大家直接上 Visual Studio 2019.
...
## 3. 故障排除
如果您在启动服务端程序时遇到问题, 首先要做的就是检查控制台上输出的信息.
在大多数情况下所有常见的问题只需要查看给出的错误消息即可解决.
...
## 6. 如何贡献
有关如何为熊猫模拟器做出贡献的详细信息, 请参见 [CONTRIBUTING.md](https://github.com/PandasWS/Pandas/blob/master/.github/CONTRIBUTING.md)!
