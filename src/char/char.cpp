...
#else
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 9,  SQLDT_UINT,   &p.str, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 10, SQLDT_UINT,   &p.agi, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 11, SQLDT_UINT,   &p.vit, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 12, SQLDT_UINT,   &p.int_, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 13, SQLDT_UINT,   &p.dex, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 14, SQLDT_UINT,   &p.luk, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
...
#else
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 49, SQLDT_UINT,   &p.pow, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 50, SQLDT_UINT,   &p.sta, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 51, SQLDT_UINT,   &p.wis, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 52, SQLDT_UINT,   &p.spl, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 53, SQLDT_UINT,   &p.con, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 54, SQLDT_UINT,   &p.crt, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
...
#else
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 10, SQLDT_UINT,   &p->str, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 11, SQLDT_UINT,   &p->agi, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 12, SQLDT_UINT,   &p->vit, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 13, SQLDT_UINT,   &p->int_, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 14, SQLDT_UINT,   &p->dex, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 15, SQLDT_UINT,   &p->luk, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
...
#else
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 66, SQLDT_UINT,   &p->pow, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 67, SQLDT_UINT,   &p->sta, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 68, SQLDT_UINT,   &p->wis, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 69, SQLDT_UINT,   &p->spl, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 70, SQLDT_UINT,   &p->con, 0, nullptr, nullptr)
	||	SQL_ERROR == SqlStmt_BindColumn(stmt, 71, SQLDT_UINT,   &p->crt, 0, nullptr, nullptr)
#endif // Pandas_Extreme_Computing
