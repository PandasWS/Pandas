...
enum npce_event : uint8 {
	...
	NPCE_CASHSHOPBUY,	// cashshop_buy_event_name	// OnPCCashShopBuyEvent		// 商城购买成功后触发事件 [聽風]
#endif // Pandas_NpcEvent_CASHSHOPBUY

#ifdef Pandas_NpcEvent_CASHSHOPCLOSE
	NPCE_CASHSHOPCLOSE,	// cashshop_close_event_name	// OnPCCashShopCloseEvent		// 关闭商城后触发事件 [聽風]
