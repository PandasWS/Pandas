...
def arrange_common(packagedir):
    ...
    os.makedirs(packagedir + 'sql-files/main/use_sql_db')
    shutil.move(packagedir + 'sql-files/mob_db.sql', packagedir + 'sql-files/main/use_sql_db/01.mob_db.sql')
    shutil.move(packagedir + 'sql-files/mob_db_re.sql', packagedir + 'sql-files/main/use_sql_db/02.mob_db_re.sql')
    shutil.move(packagedir + 'sql-files/mob_db2.sql', packagedir + 'sql-files/main/use_sql_db/03.mob_db2.sql')
    shutil.move(packagedir + 'sql-files/mob_db2_re.sql', packagedir + 'sql-files/main/use_sql_db/04.mob_db2_re.sql')
    shutil.move(packagedir + 'sql-files/mob_skill_db.sql', packagedir + 'sql-files/main/use_sql_db/05.mob_skill_db.sql')
    shutil.move(packagedir + 'sql-files/mob_skill_db_re.sql', packagedir + 'sql-files/main/use_sql_db/06.mob_skill_db_re.sql')
    shutil.move(packagedir + 'sql-files/mob_skill_db2.sql', packagedir + 'sql-files/main/use_sql_db/07.mob_skill_db2.sql')
    shutil.move(packagedir + 'sql-files/mob_skill_db2_re.sql', packagedir + 'sql-files/main/use_sql_db/08.mob_skill_db2_re.sql')
    
    shutil.move(packagedir + 'sql-files/item_cash_db.sql', packagedir + 'sql-files/main/use_sql_db/09.item_cash_db.sql')
    shutil.move(packagedir + 'sql-files/item_cash_db2.sql', packagedir + 'sql-files/main/use_sql_db/10.item_cash_db2.sql')
    shutil.move(packagedir + 'sql-files/item_db.sql', packagedir + 'sql-files/main/use_sql_db/11.item_db.sql')
    shutil.move(packagedir + 'sql-files/item_db_re.sql', packagedir + 'sql-files/main/use_sql_db/12.item_db_re.sql')
    shutil.move(packagedir + 'sql-files/item_db2.sql', packagedir + 'sql-files/main/use_sql_db/13.item_db2.sql')
    shutil.move(packagedir + 'sql-files/item_db2_re.sql', packagedir + 'sql-files/main/use_sql_db/14.item_db2_re.sql')
    
    os.makedirs(packagedir + 'sql-files/main/optional')
    shutil.move(packagedir + 'sql-files/premium_storage.sql', packagedir + 'sql-files/main/optional/01.premium_storage.sql')
