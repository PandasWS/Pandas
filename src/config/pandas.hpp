...
// ============================================================================
	...
	// 缓解复杂网络结构中魔物死亡但客户端没移除魔物单位的问题 [Sola丶小克]
	// 造成问题的主因是: 魔物死亡后会发送 clif_clearunit_area 的 CLR_DEAD 封包给客户端
	...
	//
	// 下面宏定义开关的值是延迟的毫秒数, 这个取值不能太大 (间隔不能太久), 否则一方面没意义,
	// 另外一方面如果魔物由于其他机制用相同的 GameID 复活则会导致它被错误的移除
	#define Pandas_Send_Twice_ClearUnit_For_Dead_Mob 64
